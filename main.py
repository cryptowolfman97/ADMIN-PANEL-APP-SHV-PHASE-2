...
class LicenseManagerScreen(Screen):
    ...
    def build_licenses_view(self):
        ...
        copy_backup_btn = make_button("Copy License Backup", ORANGE)
        ...
        save_backup_btn = make_button("Save License Backup", BLUE)
        ...
        paste_btn = make_button("Paste", BLUE)
        import_file_btn = make_button("Import Backup File", PURPLE)
    ...
    def build_revocation_view(self):
        ...
        row = BoxLayout(size_hint_y=None, height=dp(46), spacing=dp(8))
        save_btn = make_button("Save synapse_revoked_licenses.json", BLUE)
        ...
        for title, widget in [
            ...
            if widget is self.github_token_input:
                paste_token_btn = make_button("Paste Token", PURPLE)
...
def build_stat_chip(value, label, accent=GREEN):
    ...
    l = Label(text=str(label), color=get_color_from_hex(SUBTEXT), font_size='11sp', size_hint_y=None, height=dp(18))
    card.add_widget(v)
    card.add_widget(l)
    return card
...
def build_screen_header(title, subtitle='', back_target='home', extra=None):
    ...
    row = BoxLayout(size_hint_y=None, height=dp(42), spacing=dp(8))
    if back_target:
        back_btn = make_button('Back', ORANGE)
...
class AdminHomeScreen(Screen):
    ...
    def refresh_ui(self, *_):
        ...
        for summary, accent, screen_name in ((syn, GREEN, 'synapse_manager'), (ctp, PURPLE, 'casino_manager')):
            ...
            grid.add_widget(build_stat_chip(summary['last_backup'], 'Last Backup', ORANGE))
        ...
        syn_stats.add_widget(build_stat_chip(synapse_summary['latest'], 'Updated', ORANGE))
        ...
        syn_time_btn = make_button('Universal Time', PURPLE)
        ...
        backup_btn = make_button('App Data Backup', BLUE)
        ...
        _ws_stats.add_widget(build_stat_chip(_ws_latest[-5:] if _ws_latest != '--' else '--', 'Updated', ORANGE))
        websites_card.add_widget(_ws_stats)
        _ws_open_btn = make_button('Open Websites', PURPLE)
...
class LicensingAppsScreen(Screen):
    ...
    def refresh_ui(self, *_):
        ...
        for summary, screen_name, color in ((product_summary('Synapse'), 'synapse_manager', GREEN), (product_summary('Casino Tools Pro'), 'casino_manager', PURPLE)):
            ...
            stats.add_widget(build_stat_chip(summary['last_backup'], 'Last Backup', ORANGE))
...
class BackupVaultScreen(Screen):
    ...
    def refresh_ui(self, *_):
        ...
        ctp_btn = make_button('Open Casino Tools Vault', PURPLE)
...
class CustomersScreen(Screen):
    ...
    def build_ui(self, *_):
        ...
        row = BoxLayout(size_hint_y=None, height=dp(46), spacing=dp(8))
        export_btn = make_button('Export CSV', BLUE)
        refresh_btn = make_button('Refresh', PURPLE)
    ...
    def refresh_list(self, *_):
        ...
        for row in rows:
            ...
            edit_btn = make_button('Edit', PURPLE)
            copy_btn = make_button('Copy ID', BLUE)
...
class ReleaseTrackerScreen(Screen):
    ...
    def build_ui(self, *_):
        ...
        refresh_btn = make_button('Refresh', BLUE)
    ...
    def refresh_list(self, *_):
        ...
        for idx, row in enumerate(entries):
            ...
            copy_btn = make_button('Copy Link', BLUE)
...
class DocumentationScreen(Screen):
    ...
    def build_ui(self, *_):
        ...
        copy_module = make_button('Copy New Module Guide', BLUE)
        row1.add_widget(copy_full)
        row1.add_widget(copy_module)
        row2 = BoxLayout(size_hint_y=None, height=dp(46), spacing=dp(8))
        copy_pem = make_button('Copy PEM Notes', PURPLE)
        to_home = make_button('Back Home', ORANGE)
...
class SynapseManagerShellScreen(Screen):
    ...
    def build_ui(self, *_):
        ...
        back_btn = make_button('Back to Apps', ORANGE)
        home_btn = make_button('Admin Home', BLUE)
        vault_btn = make_button('Vault', PURPLE)
...
class AdminSynapseProjectsScreen(Screen):
    ...
    def refresh_ui(self, *_):
        ...
        time_btn = make_button('Universal Time', PURPLE)
        ...
        for row in rows:
            ...
            btns = BoxLayout(size_hint_y=None, height=dp(42), spacing=dp(8))
            open_btn = make_button('Details', BLUE)
            edit_btn = make_button('Edit', PURPLE)
            del_btn = make_button('Delete', RED)
    ...
    def open_project_details(self, row):
        ...
        content.add_widget(lbl)
        row_btn = BoxLayout(size_hint_y=None, height=dp(46), spacing=dp(8))
        copy_btn = make_button('Copy Summary', BLUE)
        edit_btn = make_button('Edit', PURPLE)
...
class AdminSynapseUniversalTimeScreen(Screen):
    ...
    def build_ui(self, *_):
        ...
        btn_row = BoxLayout(size_hint_y=None, height=dp(46), spacing=dp(8))
        convert_btn = make_button('Convert', BLUE)
        copy_btn = make_button('Copy Result', PURPLE)
...
class AppDataBackupScreen(Screen):
    ...
    def build_ui(self, *_):
        ...
        save_cfg_btn = make_button('Save Settings', BLUE)
        ...
        list_btn = make_button('List Backup Files', BLUE)
        ...
        paste_btn = make_button('Paste from Clipboard', BLUE)
...
class WebsitesScreen(Screen):
    ...
    def refresh_ui(self, *_):
        ...
        for site in self.sites:
            ...
            row = BoxLayout(size_hint_y=None, height=dp(46), spacing=dp(8))
            open_btn = make_button('Open', PURPLE)
            edit_btn = make_button('Edit', BLUE)
    ...
    def open_site_detail(self, site_id):
        ...
        for page in site.get('pages', []):
            ...
            row = BoxLayout(size_hint_y=None, height=dp(46), spacing=dp(8))
            copy_btn = make_button('Copy HTML', BLUE)
            edit_btn = make_button('Edit Page', PURPLE)
        ...
        edit_site = make_button('Edit Website', PURPLE)
    ...
    def open_page_editor(self, site_id, page_id=None):
        ...
        paste_btn = make_button('Paste HTML', BLUE)
        copy_btn = make_button('Copy HTML', PURPLE)
...
def _new_admin_build(self):
    ...
    sm.add_widget(AdminSynapseProjectsScreen(name='synapse_projects'))
    sm.add_widget(AdminSynapseUniversalTimeScreen(name='synapse_universal_time'))
...
def _admin_home_refresh_ui_with_sound_controls(self, *_):
    ...
    test_bg_btn = make_button('Restart Music', BLUE)
    ...
    minus_btn = make_button('Volume -', BLUE)
...
def _button_fill_for(color_hex):
    color = str(color_hex or UI_GREEN).lower()
    if color in (str(UI_GREEN).lower(), str(GREEN).lower()):
        return '#0e1a13'
    if color in (str(UI_CYAN).lower(), str(BLUE).lower()):
        return '#0d1821'
    if color in (str(UI_PURPLE).lower(), str(PURPLE).lower()):
        return '#16101d'
    if color in (str(UI_ORANGE).lower(), str(ORANGE).lower()):
        return '#1b1410'
    if color in (str(UI_RED).lower(), str(RED).lower()):
        return '#1c1013'
    return '#10161d'
...
def build_top_title(text, size='30sp'):
    ...
    lbl.bind(size=lambda inst, val: setattr(inst, 'text_size', val))
    box.add_widget(lbl)
    sub = _soft_text('Enterprise licensing, websites, operations, backups, and embedded Synapse tools.', size='13sp', color=UI_MUTE, height=dp(22), halign='center')
    box.add_widget(sub)
...
def build_screen_header(title, subtitle='', back_target='home', extra=None):
    ...
    if back_target:
        back_btn = make_button('Back', UI_ORANGE)
        back_btn.bind(on_release=lambda *_: setattr(App.get_running_app().root, 'current', back_target))
        row.add_widget(back_btn)
    if extra:
...
def _premium_admin_home_refresh_ui(self, *_):
    ...
    hero = SectionCard('CONTROL DASHBOARD', 'Private enterprise command center for product licensing, websites, operations, backups, and embedded Synapse workspace.', accent=UI_GREEN)
    ...
    hero_stats.add_widget(build_stat_chip(synapse_summary.get('total', 0), 'Synapse Projects', UI_TEAL))
    ...
    for label, fn, color in [
        ...
        ('Open Synapse Projects', lambda: setattr(self.manager, 'current', 'synapse_projects'), UI_TEAL),
    ]:
        btn = make_button(label, color)
        btn.bind(on_release=lambda *_ , f=fn: f())
    ...
    toggle_lbl = make_label('Collapse product cards to save main-screen space.' if not self._product_dashboard_collapsed else 'Expand to show all product lanes and quick open buttons.', color=SUBTEXT, height=dp(46))
    toggle_lbl.size_hint_x = 1
    toggle_btn = make_button('Expand' if self._product_dashboard_collapsed else 'Collapse', UI_GREEN if self._product_dashboard_collapsed else UI_ORANGE)
    ...
    if self._product_dashboard_collapsed:
        ...
        for summary, accent, screen_name in product_rows:
            ...
            stats.add_widget(build_stat_chip(summary['last_backup'], 'Last Backup', UI_ORANGE))
            card.add_widget(stats)
            open_btn = make_button(f'Open {summary["product"]}', accent)
            open_btn.bind(on_release=lambda *_ , s=screen_name: setattr(self.manager, 'current', s))
            card.add_widget(open_btn)
    ...
    synapse_card = SectionCard('SYNAPSE WORKSPACE', 'Projects and global time conversion are embedded here for long-term internal use.', accent=UI_TEAL)
    syn_stats = GridLayout(cols=3, spacing=dp(8), size_hint_y=None, height=dp(72))
    syn_stats.add_widget(build_stat_chip(synapse_summary['total'], 'Projects', UI_TEAL))
    syn_stats.add_widget(build_stat_chip(synapse_summary['active'], 'Active', UI_CYAN))
    syn_stats.add_widget(build_stat_chip(synapse_summary['latest'], 'Updated', UI_ORANGE))
    synapse_card.add_widget(syn_stats)
    syn_row = GridLayout(cols=2, spacing=dp(8), size_hint_y=None, height=dp(46))
    syn_projects_btn = make_button('Projects', UI_TEAL)
    syn_time_btn = make_button('Universal Time', UI_PURPLE)
    syn_projects_btn.bind(on_release=lambda *_: setattr(self.manager, 'current', 'synapse_projects'))
    syn_time_btn.bind(on_release=lambda *_: setattr(self.manager, 'current', 'synapse_universal_time'))
    syn_row.add_widget(syn_projects_btn)
    syn_row.add_widget(syn_time_btn)
    ...
    ws_stats.add_widget(build_stat_chip(total_pages, 'Pages', UI_TEAL))
    ws_latest = _sites_data[0].get('updated_at', '--') if _sites_data else '--'
    ws_stats.add_widget(build_stat_chip(_ws_latest[-5:] if (_ws_latest := ws_latest) != '--' else '--', 'Updated', UI_ORANGE))
...
def _build_cloud_backup_card(self):
    ...
    row1 = BoxLayout(size_hint_y=None, height=dp(46), spacing=dp(8))
    save_btn = make_button('Save Cloud Settings', BLUE)
    ...
    row2 = BoxLayout(size_hint_y=None, height=dp(46), spacing=dp(8))
    list_btn = make_button('List Remote Files', PURPLE)
